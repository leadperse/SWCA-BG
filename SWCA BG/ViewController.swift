...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var pics = ["ABC" ,"AT 1","Cus","Cul","Cyber","Dental","Early Childhood","Electrical","ER","IandE","IMD","MedicalDataManagement 1","MobileApps","MultiskilledHealth","prenursing","Welding"]
    
    var classesOfQuestions: [[LabQuestion]] = [AutoBodyCollison,AutoTech,Cosmetology,Culinary,Cyber,Dental,EarlyChildHood,Electrical,Enginering,Enterpurniship,IMD,MobileApps,Multi_skilled,Pre_nursing,Welding]
